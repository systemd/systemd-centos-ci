...
./agent-control.py --pool metal-ec2-c5n-centos-8s-x86_64 --bootstrap-args='-s' --no-index --vagrant arch-sanitizers-gcc ${ARGS:+"${ARGS[@]}"}
./agent-control.py --pool metal-ec2-c5n-centos-8s-x86_64 --bootstrap-args='-s' --no-index --vagrant arch-sanitizers-clang ${ARGS:+"${ARGS[@]}"}
